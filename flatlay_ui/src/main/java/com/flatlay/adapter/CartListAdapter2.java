...
public class CartListAdapter2 extends BaseAdapter {
	...
	public CartListAdapter2(FragmentActivity context, List<Product> data, FragmentUserCart fragmentUserCart, boolean isPopup, List<TwoTapProductDetails> productDetails) {
		super();
		...
		Log.w("Activity","CartListAdapter2");
	}
