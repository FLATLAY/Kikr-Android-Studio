...
import com.flatlay.adapter.PinterestBoardAdapter;
...
public class PinterestBoardDialog2 extends Dialog {
    ...
    public PinterestBoardDialog2(FragmentActivity context, List<PDKBoard> bgImages, String imageUrl, String text, String link) {
    ...
    public PinterestBoardDialog2(FragmentActivity context, int theme) {
        super(context, R.style.AdvanceDialogTheme);
        mContext = context;
        init();
    }
