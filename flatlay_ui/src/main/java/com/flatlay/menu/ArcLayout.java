...
public class ArcLayout extends ViewGroup {
    ...
    private void bindChildAnimation(final View child, final int index, final long duration) {
        ...
        Syso.info("Animation.. In bindChildAnimation expanded:"+expanded+", mExpanded:"+mExpanded);
        
        final int centerX = getWidth() / 2;
        final int centerY = getHeight() / 2;
        final int radius = expanded ? 0 : mRadius;
        Syso.info("Animation... centerX:"+centerX+", centerY:"+centerY+", radius:"+radius);
        ...
        Syso.info("Animation... toXDelta:"+toXDelta+", toYDelta:"+toYDelta+", perDegrees:"+perDegrees);
        
        Interpolator interpolator = mExpanded ? new AccelerateInterpolator() : new OvershootInterpolator(1.5f);
        final long startOffset = computeStartOffset(childCount, mExpanded, index, 0.1f, duration, interpolator);

        Syso.info("Animation... startOffset:"+startOffset);
