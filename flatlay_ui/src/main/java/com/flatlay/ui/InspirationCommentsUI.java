...
public class InspirationCommentsUI {
    ...
    public View getView() {
        ...
        for ( int i = 0; i < data.size(); i++) {
            ...
            userName.setTypeface(FontUtility.setMontserratLight(mContext));
            userName.setVisibility(View.GONE);
            TextView commentText = (TextView) convertView.findViewById(R.id.commentText);
            commentText.setTypeface(FontUtility.setMontserratLight(mContext));
            ImageView deletecomment= (ImageView) convertView.findViewById(R.id.deleteComment);
            CircleImageView userImage = (CircleImageView) convertView.findViewById(R.id.userImage);
