...
public class MyMaterialContentOverflow extends FrameLayout {
    ...
    public MyMaterialContentOverflow(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public MyMaterialContentOverflow(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public MyMaterialContentOverflow(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public MyMaterialContentOverflow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
