...
public class CheckPointsStatusApi extends AbsService {

	private String requestValue;
	private String requestType;

	public CheckPointsStatusApi(ServiceCallback serviceCallback) {
		super();
		this.mServiceCallback = serviceCallback;
	}

	public void checkcartpointstatus(String user_id) {
		this.METHOD_NAME = WebConstants.HOST_FILE + "checkcartpointstatus";
	...
	public void checkcollectionpointstatus(String user_id) {
		this.METHOD_NAME = WebConstants.HOST_FILE + "checkcollectionpointstatus";
		requestType = WebConstants.HTTP_METHOD_POST;
		Map<String, String> comment = new HashMap<String, String>();
		comment.put("user_id", user_id);
		Map[] maps = new Map[] { comment };
	...
	protected void processResponse(String response) {
		...
		try {
			...
			serviceResponse = checkPointStatusRes;
