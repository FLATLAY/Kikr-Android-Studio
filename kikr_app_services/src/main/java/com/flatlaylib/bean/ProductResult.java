...
public class ProductResult {
    ...
    public String getProsperantproductId() {
        return prosperantproductId;
    }

    public void setProsperantproductId(String prosperantproductId) {
        this.prosperantproductId = prosperantproductId;
    }
