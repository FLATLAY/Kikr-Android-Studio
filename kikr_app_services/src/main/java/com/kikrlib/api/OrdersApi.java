...
public class OrdersApi extends AbsService {

	private String requestValue;
	private String requestType;

	public OrdersApi(ServiceCallback serviceCallback) {
		super();
		this.mServiceCallback = serviceCallback;
	}

	public void getOrdersList(String user_id,String pagenum) {
		this.METHOD_NAME = WebConstants.HOST_FILE + "orderlist";
	...
	public void getOrderDetails(String user_id,String order_id) {
		this.METHOD_NAME = WebConstants.HOST_FILE + "orderdetail";
		requestType = WebConstants.HTTP_METHOD_POST;
		Map<String, String> comment = new HashMap<String, String>();
		comment.put("user_id", user_id);
		comment.put("order_id", order_id);
		Map[] maps = new Map[] { comment };
		Gson gson = new Gson();
		requestValue = gson.toJson(maps);
	}
