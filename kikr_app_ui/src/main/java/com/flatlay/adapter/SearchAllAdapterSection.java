...
public class SearchAllAdapterSection extends ArrayAdapter<Item> {

    private FragmentActivity mContext;
    private ArrayList<Item> items;
    private LayoutInflater vi;
    private FragmentSearchAll fragmentSearchAll;
    private ProgressBarDialog mProgressBarDialog;

    public SearchAllAdapterSection(FragmentActivity context, ArrayList<Item> items, FragmentSearchAll fragmentSearchAll) {
        ...
        if (i != null) {
            if (i.isSection()) {
                ...
                if (item.getIs_followed().equalsIgnoreCase("yes")) {
                    ...
                    follow_btn.setBackground(mContext.getResources().getDrawable(R.drawable.btn_borderbg_gray));
                    ...
                    follow_btn.setCompoundDrawablesWithIntrinsicBounds(imgResource, 0, 0, 0);
                    follow_btn.setTextColor(mContext.getResources().getColor(R.color.app_text_color));
                }
                ...
                follow_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    @Override
                    public void onClick(View v) {
                        if (!TextUtils.isEmpty(item.getIs_followed()) && fragmentSearchAll.checkInternet2()) {
