...
import com.kikrlib.api.DeletePostApi;
...
public class FragmentInspirationDetail extends BaseFragment implements OnClickListener, TextView.OnEditorActionListener {
    ...
    private ImageView inspirationImage,deletePost;
    ...
    public FragmentInspirationDetail(Inspiration inspiration, boolean isShowProducts,boolean showhide,boolean isFromNofication) {
        this.inspiration = inspiration;
        this.isShowProducts = isShowProducts;
        this.isFromNotification=false;
        this.showhide=true;
    ...
    public void setData(Bundle bundle) {
        ...
        deletePost.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                RemoveProduct removeProduct = new RemoveProduct(mContext, inspiration, fragmentInspirationDetail, new CallBack() {
