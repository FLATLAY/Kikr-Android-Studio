...
package com.kikr.GallerychacheKikr;
...
public class ImageWorker {
     ...
     * {@link ImageWorker#processBitmap(com.example.android.displayingbitmaps.GallerychacheKikr.ImageWorker.AsyncParam)}  to define the processing logic). A memory and
