...
public class HomeActivity extends FragmentActivity implements OnClickListener, OnLoginCompleteListener {
    ...
    public static TextView uploadphoto, menuBackTextView;
...
//                Syso.info("===================== kikrCredit: "+kikrCredit+",localCount:"+localCount);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.homeImageView:
                ...
                loadFragment(new MainFragmentContainer());
                break;
    ...
    public void setupData() {
        if (getIntent().getStringExtra("inspiration_id") != null) {
            ...
            addFragment(new MainFragmentContainer());
        ...
        shortUrlBuilder.generateShortUrl(new Branch.BranchLinkCreateListener() {
            ...
            public void onLinkCreate(String url, BranchError error) {
                if (error != null) {
                    ...
                    intent.putExtra(Intent.EXTRA_TEXT, context.getResources().getString(R.string.text_join) + " #" + app_title + "@MY"+app_title+ " \n" + url);

                    startActivity(Intent.createChooser(intent, "Earn 25 credits for each "+app_title + " sign up!"));
...
//			}
    ...
    public void onBackPressed() {
        try {
            ...
            if (fragment instanceof FragmentPostUploadTab || fragment instanceof MainFragmentContainer ||
...
//				progressBarDialog.dismiss();
    ...
    private void checkBackButton(Fragment fragment) {
        if (fragment instanceof FragmentDiscoverDetail
                ...
                || fragment instanceof FragmentPostUploadTag
