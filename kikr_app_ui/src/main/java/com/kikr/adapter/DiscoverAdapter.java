...
public class DiscoverAdapter extends BaseAdapter{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView==null) {
			convertView = mInflater.inflate(R.layout.adapter_discover_large,null);
		...
		viewholder.user_profile_image.setVisibility(View.INVISIBLE);
		...
		if(getItem(position).getType().equals("people")){
			...
			if(getItem(position).getItem_image().equals(""))
				viewholder.brand_image.setImageResource(R.drawable.ic_profile_bg);
			else
				CommonUtility.setImage(mContext,getItem(position).getItem_image(),viewholder.brand_image,R.drawable.linesplaceholder);
		...
		if(name!=null&&!name.equals(""))
			viewholder.brand_name.setText(name);
		else
			viewholder.brand_name.setText("Unknown");
...
//			viewholder.activity_product_list_category_image.setVisibility(View.VISIBLE);
			viewholder.product_inflater_layout.addView(new ProductListUI(mContext, getItem(position),mFragmentDiscover,convertView).getView());
...
//			viewholder.activity_product_list_category_image.setVisibility(View.GONE);
		...
		viewholder.follow_btn_layout.setVisibility(View.GONE);
...
//				mProgressBarDialog.dismiss();
	...
	public class ViewHolder {
		TextView brand_name;
		ImageView brand_image,user_profile_image;
