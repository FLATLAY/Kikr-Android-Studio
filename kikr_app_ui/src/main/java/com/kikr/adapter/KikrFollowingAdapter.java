...
public class KikrFollowingAdapter extends RecyclerView.Adapter<KikrFollowingAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        //String onlyusername=firstword(userstring);
        ...
        try {
            ...
            Picasso.with(context).load(followingList.get(i).getImg()).into(viewHolder.username);
            Picasso.with(context).load(followingList.get(i).getImg()).into(viewHolder.follower_user_image);
            viewHolder.week.setText(" before " + printDifference(date2, date1));
...
//        return result;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        GridView gridview;
        ImageView username,follower_user_image;
        ...
        public ViewHolder(View view) {
            ...
            username= (ImageView) view.findViewById(R.id.user_image);
