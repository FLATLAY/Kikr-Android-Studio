...
import com.kikr.feed_adapter_copy.CustomizeFeedAllAdapter;
import com.kikr.feed_adapter_copy.CustomizeInterestBrandListAdapter;
import com.kikr.feed_adapter_copy.CustomizeInterestCategoryListAdapter;
import com.kikr.feed_adapter_copy.CustomizeInterestPeopleListAdapter;
import com.kikr.feed_adapter_copy.CustomizeInterestStoreListAdapter;
        ...
        final SearchAllApi searchAllApi = new SearchAllApi(new ServiceCallback() {
            ...
            public void handleOnSuccess(Object object) {
                ...
                if (itemArrayList.size() == 3 && isFirstTime)
                    ...
                    searchAllAdapter = new CustomizeFeedAllAdapter(mContext, itemArrayList);
                    interestSectionList.setAdapter(searchAllAdapter);
                    // interestSectionList.setSelection(itemArrayList.size()-10);
