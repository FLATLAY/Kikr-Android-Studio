...
import com.kikr.dialog.RemoveProductFragmentEditPur;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
               ...
               // ((HomeActivity) mContext).addFragment(new FragmentDiscoverDetail());
                if(product.getProductcart_id()==null)
                {
                   // ((HomeActivity) mContext).onBackPressed();
                    Toast.makeText(mContext,"You Have not added item in the cart",Toast.LENGTH_LONG).show();
                }
                else {

                    RemoveProductFragmentEditPur removeProductFromCartDialog = new RemoveProductFragmentEditPur(mContext, product.getProductcart_id(), fragmentUserCart, new CallBack() {
            ...
            case R.id.productQuantity:
                quantityDialog = new QuantityDialog(mContext, editPurchaseItem, product);
                quantityDialog.show();
                break;
