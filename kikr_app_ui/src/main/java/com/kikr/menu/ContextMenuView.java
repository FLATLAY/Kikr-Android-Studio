...
import com.kikr.utility.ProductVariableOption;
...
public class ContextMenuView extends FrameLayout {
    ...
    private static final int[] ITEM_DRAWABLES = {R.drawable.ic_like_unselected, R.drawable.ic_add_collection_unselect,
            R.drawable.ic_cart_unselect, R.drawable.ic_share_unselect};
    private static final int[] ITEM_DRAWABLES_SELECTED = {R.drawable.ic_like_selected, R.drawable.ic_add_collection_selected,
            R.drawable.ic_cart_selected, R.drawable.ic_share_selected};
